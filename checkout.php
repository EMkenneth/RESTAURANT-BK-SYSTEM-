...
if(empty($_SESSION["user_id"]))
{
	header('location:login.php');
												...
												$item_total += ($item["price"]*$item["quantity"]);
													...
													$SQL="insert into customer_orders(customer_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 payment-options color-gray">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#"> <img src="images/AIREL.jpg" alt="AIRTEL"> </a>
                                        </li>
                                        <li>
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>ZEROBWE ROAD A LONG SIDE BUGEMA UNIVERSIT</p>
                                    <h5>Phone: +256750602500</a></h5> </div>
