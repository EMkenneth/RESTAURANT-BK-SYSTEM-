            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="your_orders.php">Your Orders <span class="sr-only"></span></a> </li>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                            <div class="image-wrap">
                                <figure><?php echo '<img src="Res_img/' . $rows['image'] . '" alt="Meal">'; ?></figure>
                            </div>
                        </div>
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                ...
                                ?>
                                    ...
                                    <div class="title-row">
                                        <?php echo $item["title"]; ?><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["product_id"]; ?>">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                <p>TOTAL</p>
                                <h3 class="value"><strong><?php echo "ugx" . $item_total; ?></strong></h3>
                                <p>Free Delivery!!!</p>
                                <?php
                                if ($item_total ==0) {
                                ?>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-8">
                                                <form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=add&id=<?php echo $product['product_id']; ?>'>
                                                    <div class="rest-logo pull-left">
                                                        <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="Res_img/dishes/' . $product['img'] . '" alt="Food logo">'; ?></a>
                                                    </div>
                    ...
                    <div class="food-item white">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div class="rest-descr">
                                    <h6><a href="#">MATOOKE AND GNUT SOURCE Menü (28 - 30 cm.)</a></h6>
                                </div>
                    ...
                    <div class="food-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div class="rest-descr">
                                    <h6><a href="#">MATOOKE AND GNUT <SOURCE:media></SOURCE:media> Menü (28 - 30 cm.)</a></h6>
                                </div>
                    ...
                    <div class="food-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div class="rest-descr">
                                    <h6><a href="#">MATOOKE AND BEANS Menü (28 - 30 cm.)</a></h6>
                                </div>
