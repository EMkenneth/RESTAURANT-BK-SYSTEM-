...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> Restaurant BK management system</a>
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="your_reservation.php">Your Table Booking <span class="sr-only"></span></a> </li>
    ...
    <section< class="hero bg-image" data-image-src="images/img/food.jpg">
            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span>1. </span>SELECT YOUR MEAL</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span>3. </span>DELIVER OR TAKE AWAY</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Food of the Month</h2>
                ...
                while ($r = mysqli_fetch_array($query_res)) {
                    ...
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="Res_img/dishes/' . $r['img'] . '"></div>
                                                <div class="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">CASH ON DELIVERY OR MOBILE MONEY PAYEMENT </p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="restaurant-listing">
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id=' . $rows['rs_id'] . '" > <img src="Res_img/' . $rows['image'] . '" alt="fd-logo"> </a>
																</div>
                    ...
                    <div>
                        <h1>A table booking form</h1>

                        <form action="insert.php" method="post">
                            Cutomer ID: <input type="number" name="customer_id" /><br><br>

                            TableNumber: <input type="number" name="tablenumber" /><br><br>
                            BookingDate: <input type="Date" name="bookingdate" /><br><br>
                            ExpectedDate: <input type="Date" name="expecteddate" /><br><br>
            ...
            <div class="bottom-footer">
                <div class="row">
                    <div class="col-xs-12 col-sm-3 payment-options color-gray">
                        ...
                        <ul>
                            <li>
                                <a href="#"> <img src="images/money.jpg" alt="money"> </a>
                            </li>
                            <li>
                                <a href="#"> <img src="images/MTN.jpg" alt="MTN"> </a>
                            </li>
                            <li>
                                <a href="#"> <img src="images/AIRTEL.jpg" alt="AIRTEL"> </a>
                            </li>
                            <li>
                ...
                <div class="col-xs-12 col-sm-4 address color-gray">
                    <h5>Address</h5>
                    <p>ZEROBWE ROAD A LONG SIDE BUGEMA UNIVERSITY </p>
                    <h5>Phone: +256750602500</a></h5>
                </div>
